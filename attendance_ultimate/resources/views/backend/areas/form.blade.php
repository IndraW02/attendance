...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            <h3 class="card-title">Tambah atau Edit</h3>
        </div>
...
@section('js')
    ...
    <script src="https://maps.googleapis.com/maps/api/js?sensor=false&libraries=geometry,drawing&ext=.js&key=AIzaSyAifoAl-uivwoA8r3K_Ic7bhMj2CTEqFWw"></script>
