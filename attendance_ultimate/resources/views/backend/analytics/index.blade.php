            ...
            <Form action="" method="get" class="form-inline col-sm-12">
                <div class="form-group mb-2">
                    ...
                    <div class="input-group">
                        <input type="text" name="from" class="form-control" id="from" placeholder="Dari Tanggal" value="{{ $param['from'] }}">
                ...
                <div class="form-group mx-sm-3 mb-2">
                    <label for="to"></label>
                    <div class="input-group">
                        <input type="text" name="to" class="form-control" id="to" placeholder="Ke Tanggal" value="{{ $param['to'] }}">
                        <div class="input-group-append" data-toggle="datetimepicker">
                            <div class="input-group-text"><i class="fa fa-calendar"></i></div>
                        </div>
                    </div>
